/turf/closed/wall
	icon = 'modular_mint/aesthetics/walls/icons/wall.dmi'
	smoothing_groups = SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_WALLS
	canSmoothWith = SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_WALLS

/turf/closed/wall/r_wall
	icon = 'modular_mint/aesthetics/walls/icons/reinforced_wall.dmi'
...
/turf/closed/wall/material
	icon = 'modular_mint/aesthetics/walls/icons/material_wall.dmi'
	icon_state = "wall-0"
	base_icon_state = "wall"
...
/obj/structure/falsewall
	icon = 'modular_mint/aesthetics/walls/icons/wall.dmi'
	fake_icon = 'modular_mint/aesthetics/walls/icons/wall.dmi'

/obj/structure/falsewall/reinforced
	name = "reinforced wall"
	desc = "A huge chunk of reinforced metal used to separate rooms."
	icon = 'modular_mint/aesthetics/walls/icons/reinforced_wall.dmi'
	fake_icon = 'modular_mint/aesthetics/walls/icons/reinforced_wall.dmi'

/obj/structure/falsewall/material
	icon = 'modular_mint/aesthetics/walls/icons/material_wall.dmi'
	icon_state = "wall-open"
	base_icon_state = "wall"
	fake_icon = 'modular_mint/aesthetics/walls/icons/material_wall.dmi'
